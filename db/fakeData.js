module.exports = {
  ...
  items: [
    ...
    {
      title: 'Nike Kobe 6 Potro Grinch',
      description: 'Released Dec 2020, this shoe will have you stealing Christmas buckets all the way to the championship',
      price: 24242424,
      inventoryquantity: 2,
      active: true,
    },
    {
      ...
      description: 'Did the Yeezys really jump over the Jumpman?',
      price: 4000000,
      inventoryquantity: 1,
      active: true,
    },
    {
      title: 'Jordan 4 Wahlburgers',
      description: 'Only 30 pairs in existence!!!',
      price: 35000000,
      inventoryquantity: 15,
      active: true,
    },
    {
      title: 'Nike Dunk SB Low What The Dunk',
      description: 'What the...Dunk?',
      price: 3132000,
      inventoryquantity: 2,
      active: true,
    },
    {
      title: 'Jordan 1 High Dior',
      description: 'Looking for the perfect wedding sneaker? Look no further!!',
      price: 989809,
      inventoryquantity: 10,
      active: true,
    },
    ...
    {
      title: 'A Pension in Time',
      description: 'I am Surrealism. By Salvador Dali',
      price: 57500000,
      inventoryquantity: 1,
      active: true,
    },
    ...
    {
      title: 'Michael Jackson Glove',
      description: 'MJ played Billie Jean the first time this glove made a world appearance at the Motown 25th anniversary.',
      price: 67500000,
      inventoryquantity: 1,
      active: true,
    },
    ...
    {
      title: 'No.1 Trainer',
      description: 'Only 7 copies made EVER !!',
      price: 8900000,
      inventoryquantity: 2,
      active: true,
    },
    {
      title: 'Black Lotus Magic the Gathering Card',
      description: 'The Alpha and Beta versions are available!',
      price: 51000000,
      inventoryquantity: 2,
      active: true,
    },
    {
      title: 'Captain America 128 Page',
      description: 'Cover Date: 1942. 128 pages no more no less.',
      price: 75000000,
      inventoryquantity: 2,
      active: true,
    },
  ...
  imagesOfItems: [
    ...
    {
      itemId: 23,
      url: '/images/Jordan_1_High_Off_White.png',
      description: 'The amount of shots that will go in will make this shoe a must buy!!',
      alttext: 'Deadstock',
    },
    {
      itemId: 23,
      url: '/images/Jordan_1_High_Off_White_1.png',
      description: 'The amount of shots that will go in will make this shoe a must buy!!',
      alttext: 'Deadstock',
    },
    {
      itemId: 24,
      url: '/images/Nike_Kobe_6_Potro_Grinch.png',
      description: 'Released Dec 2020, this shoe will have you stealing Christmas buckets all the way to the championship',
      alttext: 'Deadstock',
    },
    {
      itemId: 24,
      url: '/images/Nike_Kobe_6_Potro_Grinch_1.png',
      description: 'Released Dec 2020, this shoe will have you stealing Christmas buckets all the way to the championship',
      alttext: 'Deadstock',
    },
    {
      itemId: 25,
      url: '/images/Nike_Air_Yeezy_2.png',
      description: 'Did the Yeezys really jump over the Jumpman?',
      alttext: 'Deadstock',
    },
    {
      itemId: 25,
      url: '/images/Nike_Air_Yeezy_2_1.png',
      description: 'Did the Yeezys really jump over the Jumpman?',
      alttext: 'Deadstock',
    },
    {
      itemId: 25,
      url: '/images/Nike_Air_Yeezy_2_2.png',
      description: 'Did the Yeezys really jump over the Jumpman?',
      alttext: 'Deadstock',
    },
    {
      itemId: 26,
      url: '/images/Jordan_4_Wahlburgers.png',
      description: 'Only 30 pairs in existence',
      alttext: 'Deadstock',
    },
    {
      itemId: 26,
      url: '/images/Jordan_4_Wahlburgers_1.png',
      description: 'Only 30 pairs in existence',
      alttext: 'Deadstock',
    },
    {
      itemId: 26,
      url: '/images/Jordan_4_Wahlburgers_2.png',
      description: 'Only 30 pairs in existence',
      alttext: 'Deadstock',
    },
    {
      itemId: 26,
      url: '/images/Jordan_4_Wahlburgers_3.png',
      description: 'Only 30 pairs in existence',
      alttext: 'Deadstock',
    },
    {
      itemId: 27,
      url: '/images/Nike_Dunk_SB_Low_What_The_Dunk.png',
      description: 'What the...Dunk?',
      alttext: 'Deadstock',
    },
    {
      itemId: 27,
      url: '/images/Nike_Dunk_SB_Low_What_The_Dunk_1.png',
      description: 'What the...Dunk?',
      alttext: 'Deadstock',
    },
    {
      itemId: 27,
      url: '/images/Nike_Dunk_SB_Low_What_The_Dunk_2.png',
      description: 'What the...Dunk?',
      alttext: 'Deadstock',
    },
    {
      itemId: 28,
      url: '/images/Jordan_1_High_Dior.png',
      description: 'Looking for the perfect wedding sneaker? Look no further!!',
      alttext: 'Deadstock',
    },
    {
      itemId: 28,
      url: '/images/Jordan_1_High_Dior_1.png',
      description: 'Looking for the perfect wedding sneaker? Look no further!!',
      alttext: 'Deadstock',
    },
    {
      itemId: 29,
      url: '/images/Nike_Mag_Back_To_the_Future.png',
      description: 'Marty McFly was a head of his time.. or was he?',
      alttext: 'Deadstock',
    },
    {
      itemId: 30,
      url: '/images/A_Pension_in_Time.png',
      description: 'I am Surrealism. By Salvador Dali',
      alttext: 'Anyone have a watch?',
    },
    {
      itemId: 31,
      url: '/images/A_Starry_Night.png',
      description: 'Van Gogh knew what he was doing with this one!',
      alttext: 'Is it raining ?',
    },
    {
      itemId: 32,
      url: '/images/MJ.png',
      description: 'Made with Thriller Zombies from the music video the red on this jacket is all but a thrill!',
      alttext: 'Just beat it!',
    },
    {
      itemId: 33,
      url: '/images/MJglove.png',
      description: 'MJ played Billie Jean the first time this glove made a world appearance at the Motown 25th anniversary.',
      alttext: 'Oh Billie Jean how I miss you!',
    },
    {
      itemId: 34,
      url: '/images/Bugatti.png',
      description: 'Vroom Vroom!!!',
      alttext: 'How fast is fast?',
    },
    {
      itemId: 34,
      url: '/images/Bugatti_1.png',
      description: 'Vroom Vroom!!!',
      alttext: 'How fast is fast?',
    },
    {
      itemId: 34,
      url: '/images/Bugatti_2.png',
      description: 'Vroom Vroom!!!',
      alttext: 'How fast is fast?',
    },
    {
      itemId: 35,
      url: '/images/Numberone_Trainer.png',
      description: 'Only 7 copies made EVER !!',
      alttext: 'Gotta Catch Them All !',
    },
    {
      itemId: 36,
      url: '/images/Black_Lotus.png',
      description: 'The Alpha and Beta versions are available!',
      alttext: 'Abra KaDabra!',
    },
    {
      itemId: 37,
      url: '/images/Captain_America.png',
      description: 'Cover Date: 1942. 128 pages no more no less.',
      alttext: 'Thanos?',
    },
  ],
